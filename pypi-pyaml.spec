...
Source0  : https://files.pythonhosted.org/packages/a1/b4/41000b97447aba34a5054e90852e6b7ff5c0bc2a7e0306172176530c89e7/pyaml-24.4.0.tar.gz
...
%prep
%setup -q -n pyaml-24.4.0
cd %{_builddir}/pyaml-24.4.0
pushd ..
cp -a pyaml-24.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713457488
