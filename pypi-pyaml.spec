...
Source0  : https://files.pythonhosted.org/packages/91/83/ec63bd7b433ea2e689a41d65800bf81920b3b4c40d2ab140b1bb53884c9b/pyaml-24.7.0.tar.gz
...
%prep
%setup -q -n pyaml-24.7.0
cd %{_builddir}/pyaml-24.7.0
pushd ..
cp -a pyaml-24.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721318291
