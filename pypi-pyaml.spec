...
Source0  : https://files.pythonhosted.org/packages/d0/3d/ddd68d7e8e0173f4ce450056835b759d986fa1cab7bf1a0fa142feed93cd/pyaml-23.12.0.tar.gz
...
%prep
%setup -q -n pyaml-23.12.0
cd %{_builddir}/pyaml-23.12.0
pushd ..
cp -a pyaml-23.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703608026
