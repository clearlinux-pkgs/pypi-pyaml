...
Source0  : https://files.pythonhosted.org/packages/c1/40/94f10f32ab952c5cca713d9ac9d8b2fdc37392d90eea403823eeac674c24/pyaml-25.5.0.tar.gz
...
%prep
%setup -q -n pyaml-25.5.0
cd %{_builddir}/pyaml-25.5.0
pushd ..
cp -a pyaml-25.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748521577
