...
Source0  : https://files.pythonhosted.org/packages/c4/01/41f63d66a801a561c9e335523516bd5f761bc43cc61f8b75918306bf2da8/pyaml-25.7.0.tar.gz
...
%prep
%setup -q -n pyaml-25.7.0
cd %{_builddir}/pyaml-25.7.0
pushd ..
cp -a pyaml-25.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1752243950
